...
def gaussJordan(a):
    ...
    for k in range(n):
        ...
        a = divideRow(a, n, k, first_non_zero_col)
        a = subtractRows(a, n, k, first_non_zero_row, first_non_zero_col)
...
def divideRow(a, n, k, first_non_zero_col):
    first = a[k][first_non_zero_col]
    for i in range(k, n + 1):
        a[k][i] = a[k][i] / first
    return a

def subtractRows(a, n, k, first_non_zero_row, first_non_zero_col):
